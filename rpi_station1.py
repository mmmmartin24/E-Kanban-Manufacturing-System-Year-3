...
def subscribe(client: mqtt_client):
    def on_message(client, userdata, msg):
        ...
        if msg.topic == 'PRODUCT_STATION1':
            data['PRODUCT_STATION1'] = msg.payload.decode()
            image_path = ""
            if data['PRODUCT_STATION1'] == 'Product type: X':
                image_path = path + "X.png"
            elif data['PRODUCT_STATION1'] == 'Product type: Y':
                image_path = path + "Y.png"
            elif data['PRODUCT_STATION1'] == 'Product type: Z':
    ...
    client.subscribe('PRODUCT_STATION1')
