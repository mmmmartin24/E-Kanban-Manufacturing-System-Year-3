...
def subscribe(client: mqtt_client):
    def on_message(client, userdata, msg):
        ...
        if msg.topic == 'PRODUCT_STATION2':
            data['PRODUCT_STATION2'] = msg.payload.decode()
            image_path = ""
            if data['PRODUCT_STATION2'] == 'Product type: X':
                image_path = path + "X.png"
            elif data['PRODUCT_STATION2'] == 'Product type: Y':
                image_path = path + "Y.png"
            elif data['PRODUCT_STATION2'] == 'Product type: Z':
    ...
    client.subscribe('PRODUCT_STATION2')
